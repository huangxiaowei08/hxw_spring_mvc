package cn.com.hxw.study.aspect;
...
public class WebLogAspect {
    ...
    //Service层切点
    @Pointcut("@annotation(cn.com.hxw.study.my.annotation.SystemServiceLog)")
    public void serviceAspect() {
    }

    //Controller层切点
    @Pointcut("@annotation(cn.com.hxw.study.my.annotation.SystemControllerLog)")
